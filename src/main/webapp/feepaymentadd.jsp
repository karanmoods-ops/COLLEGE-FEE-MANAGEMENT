...
<body style="margin:0; background:linear-gradient(135deg,#ff9a9e,#fad0c4); height:100vh; display:flex; justify-content:center; align-items:center;">
...
<div style="text-align:center; background:rgba(255,255,255,0.25); padding:40px; border-radius:20px;">
    ...
    <form action="addFee" method="post">
        ...
        <button type="submit"
        style="padding:10px 25px; background:#ff4d4d; color:white; border:none; border-radius:20px;">
        Submit
        </button>
